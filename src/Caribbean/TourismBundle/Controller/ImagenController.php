...
use Caribbean\TourismBundle\Form\ImagenType;
...
class ImagenController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TourismBundle:Imagen')->findAll();
     ...
     * @Method("POST")
     * @Template("TourismBundle:Imagen:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TourismBundle:Imagen')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TourismBundle:Imagen:edit.html.twig")
     */
