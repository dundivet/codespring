...
use Caribbean\TourismBundle\Entity\Rating;
use Caribbean\TourismBundle\Form\RatingType;
...
class RatingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TourismBundle:Rating')->findAll();
     ...
     * @Method("POST")
     * @Template("TourismBundle:Rating:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TourismBundle:Rating')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TourismBundle:Rating:edit.html.twig")
     */
